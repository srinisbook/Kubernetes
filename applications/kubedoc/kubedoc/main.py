...
def clusteroverview(request):
    ...
    node_html_data = nodes_data['nodes_html_data']

    namespace_html_data = namespace_data['namespace_html_data']
    namespace_count = namespace_data['namespace_count']
    pod_html_data = pods_data['pod_html_data']
    pod_count = pods_data['pod_count']
    workloads_html_data = workloads_data['workload_html_data']
    ...
    ingress_html_data = ingress_data['ingress_html_data']
    ingresses_count = ingress_data['ingress_count']
    applications_html_data = ingress_data['applications_html_data']
    service_html_data  = service_data['service_html_data']
    services_count = service_data['service_count']
    pv_html_data = pv_data['pv_html_data']
    ...
    context = {
            ...
            'masters' : masters,
            'workers' : workers,
            'node_data' : node_html_data,
            'namespace_data' : namespace_html_data,
            'namespace_count' : namespace_count,
            'applications_data' :applications_html_data,
            'pods_data' : pod_html_data,
            'pod_count' : pod_count,
            'workloads_data' : workloads_html_data,
            'deployments_count' : deployments_count,
            'statefulsets_count' : statefulsets_count,
            'daemonsets_count' : daemonsets_count,
            'service_data' : service_html_data,
            'services_count' : services_count,
            'ingress_data' : ingress_html_data,
            'ingresses_count' : ingresses_count,       
            'pv_table_data' : pv_html_data,
            'pv_count' : pv_count
        }
